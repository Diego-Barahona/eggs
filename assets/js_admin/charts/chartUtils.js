     ...
     url= "api/chart/utils";
		...
		success: (result) => {
              ...
              if(tiempo.utilidades){
                ...
                if(option == "1" ){
                  console.log("hola estoy en periodo 2 opcion 1");
                tiempo=data[0][0]; //tiempo puede ser : años o meses 
                allTimes=data[1]; // todas utlidades por meses o en años .
...
graficoEntreMeses=(periodo1,periodo2)=> { 
    ...
    if(!periodo1.tiempo1 && periodo2.tiempo1){
        msg ="El primer periodo no tiene registros para comparar. Intente nuevamente. ";
    }else if (periodo1.tiempo1 && !periodo2.tiempo1){
        msg= "El segundo periodo no tiene registros para comparar.Intente nuevamente. ";
    }
    swal({
        title: "Atención",
        icon: "warning",
...
$("#btn_generate2").on("click",getUtilsByPeriod);
$("#btn_generate3").on("click",getUtilsByPeriod);
