<div id="content-wrapper">
  <div class="container-fluid mb-5">
    ...
    <ol class="breadcrumb">
      <li class="breadcrumb-item active" id="header-title">Información de ventas</li>
    </ol>
    <input type="hidden"  name="venta" id="venta" value="<?= $venta ?>" aria-describedby="inputGroupPrepend3">
  ...
  <div class="modal fade" data-backdrop="static" data-keyboard="false" id="modal_chartSale" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
              ...
              <form>
                 <div class="form-group" id="frm_range">
                  ...
                  <div class="form-group" id="frm_range">
                      ...
                      <input type="text" class="form-control" id="modal_tipo" name="modal_codigo" disabled>
                      <div class="invalid-feedback"></div>
                  </div>
...
<script src="<?php echo base_url(); ?>assets/js_admin/charts/chartSale.js"></script>