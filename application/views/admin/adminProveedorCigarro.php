<div id="content-wrapper">
  <div class="container-fluid mb-5">
    ...
    <ol class="breadcrumb">
      <li class="breadcrumb-item active">Proveedor de Cigarros.</li>
    </ol>
    ...
    <div class="accordion" id="accordionExample">
      <div class="card mb-3">
        ...
        <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordionExample">
          <div class="card-body">
          En esta sección se mostrara los proveedores de Cigarros de la empresa.
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="card mb-3">
      <div class="card-header">
        ...
        <button class="btn btn-success float-right" type='button' data-toggle="modal" id="btn" data-target="#modal_proveedorCigarro"><i class="fas fa-plus"></i> Agregar Precio</button>
      </div>
      <div class="card-body">
