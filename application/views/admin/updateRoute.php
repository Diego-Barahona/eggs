<div id="content-wrapper">
    <div class="container-fluid mb-5" id="adminColors">
                ...
                <div class="card-body">
                    <div class="row mb-2">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <div class="input-group" id="frm_date">
                                <input type="text" class="form-control" name="date_admission" value='<?= $fecha ?>' id="date_admission" placeholder="" aria-describedby="inputGroupPrepend3">
                                <div class="invalid-feedback"></div>
                            </div>
                        </div>
                    </div>
        ...
        <div style="margin-right: 40px; margin-top: 20px; margin-bottom: 40px;">
            <button style="float: right" class="btn btn-success" type='button' id="updateRoute"> Actualizar Ruta</button>
        </div>
    </div>
</div>
...
<script src="<?php echo base_url(); ?>assets/js_admin/updateRoute.js"></script>
<script>
  $( function() {
